...
- (void)sd_setImageWithURLforPromotion:(NSURL *)url placeholderImage:(UIImage *)placeholder;
- (void)sd_setImageWithURLWithPromotion:(NSURL *)url placeholderImage:(UIImage *)placeholder options:(SDWebImageOptions)options progress:(SDWebImageDownloaderProgressBlock)progressBlock completed:(SDWebImageCompletionBlock)completedBlock;

- (void)sd_setImageWithURLforNearBy:(NSURL *)url placeholderImage:(UIImage *)placeholder;
- (void)sd_setImageWithURLWithforNearBy:(NSURL *)url placeholderImage:(UIImage *)placeholder options:(SDWebImageOptions)options progress:(SDWebImageDownloaderProgressBlock)progressBlock completed:(SDWebImageCompletionBlock)completedBlock;

- (void)sd_setImageWithURLforPlaceDetail:(NSURL *)url placeholderImage:(UIImage *)placeholder;
- (void)sd_setImageWithURLWithPlaceDetail:(NSURL *)url placeholderImage:(UIImage *)placeholder options:(SDWebImageOptions)options progress:(SDWebImageDownloaderProgressBlock)progressBlock completed:(SDWebImageCompletionBlock)completedBlock;
