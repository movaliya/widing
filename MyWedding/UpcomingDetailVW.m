...
- (void)handleFutureEventResponse:(NSDictionary*)response
{
    ...
    if ([[[response objectForKey:@"STATUS"]stringValue ] isEqualToString:@"200"])
    {
        ...
        EventDate.text=[[FutureEventDetail valueForKey:@"date"]objectAtIndex:0];
        EventDetail.text=[[FutureEventDetail valueForKey:@"details"]objectAtIndex:0];
...
- (IBAction)LocationBtn_Action:(id)sender
{
    ...
    NSString *destinationLatitude=[[FutureEventDetail valueForKey:@"latitude"]objectAtIndex:0];
    NSString *destinationLongitude=[[FutureEventDetail valueForKey:@"longitude"]objectAtIndex:0];
