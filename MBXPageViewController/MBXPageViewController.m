...
{
    NSDictionary* userInfo = @{@"total": [NSString stringWithFormat:@"%ld",(long)destination]};
    
    NSNotificationCenter* nc = [NSNotificationCenter defaultCenter];
    [nc postNotificationName:@"ChangeTab" object:self userInfo:userInfo];
...
- (void)pageViewController:(UIPageViewController *)pageViewController didFinishAnimating:(BOOL)finished previousViewControllers:(NSArray *)previousViewControllers transitionCompleted:(BOOL)completed
{
    if (completed)
    {
        ...
        NSDictionary* userInfo = @{@"total": [NSString stringWithFormat:@"%ld",(long)_currentPageIndex]};
